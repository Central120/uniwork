...
<div class="container-fluid" >
    ...
    <?php
        if (isset($_SESSION['user']) || isset($_SESSION['admin'])) {
            echo "<button type = 'button' id = 'reviewbutton' class = 'btn btn-primary' style = 'margin-bottom: 20px'>Write a Review </button>";
        }
    ?>
    ...
    if ($numberreview != 0) {
        while ($reviewrow = $searchreview->fetch_assoc()) {
            ...
            echo "<div class='card' style='width: 18rem; margin-bottom: 10px; padding-left: 100px; padding-right: 100px;'>
  <div class='card-body'>
