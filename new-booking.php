...
<form action='php/request-booking.php' method='post' role='form' id="Form1">
  ...
  <div class="form-group">
    <label for="emergency1">Emergency Contact 1</label>
      <input type="number" max='11' class="form-control" name="emergency1" id="emergency1" placeholder="Enter an emergency contact">
  </div>
  <div class="form-group">
    <label for="emergency2">Emergency Contact 2</label>
      <input type="number" max='11' class="form-control" name="emergency2" id="emergency2" placeholder="Enter a 2nd emergency contact">
  </div>
  <div class="form-group">
