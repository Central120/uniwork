    ...
    <div class="row">
      ...
      <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <div class="bg-dark rounded shadow-sm"><img src="/<?php echo $pLocation; ?>" alt="" class="img-fluid card-img-top" style="width: 100%; height: 250px; object-fit: cover;">
          <div class="p-4">
            <h5> <a href="#" class="text-white"><?php echo $productName; ?> </a></h5> <div style="float: right;"><a type='button' data-toggle='modal' id='cancel_btn' data-target='<?php echo "#manage{$imageid}";?>' class='btn btn-primary'/><i class="fa fa-gavel"></i></a> </div>
