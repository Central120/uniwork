...
<html lang="en">
  <head>
  	<title>Kerry's K9's - Home2</title>
    <meta charset="utf-8">
...
<div class="card" style="width: 18rem;">
  ...
  <div class="card-body">
    ...
    <p class="card-text"><s><?php echo "<font color='red'>£".$price."</font>"; ?></s> <?php echo "£" . $formatting; ?><br><a href="shop" class="btn btn-primary">Visit our Store</a></p>
  </div>
</div>
<?php
