...
$finddenied = mysqli_query($conn, "SELECT * FROM `reviews` WHERE `status` = 'denied'");
$countfindreview = mysqli_num_rows($finddenied);
?>
<!doctype html>
<html lang="en">
<head>
    <title>Kerry's K9's - Denied Reviews</title>
    <meta charset="utf-8">
...
<center>
    <h2 class="mb-42">Denied Reviews</h2>
    ...
    <div class="container" style='margin-bottom: 30%'>
        <div class="d-flex justify-content-center">
            <div class="table-responsive">
                ...
                {
                    echo "<h5 class='mb-5'>There are no denied reviews.</h5>";
                }
                else
                {
            ...
            <tbody>";
                    while ($rowfindreview = $finddenied->fetch_assoc())
                    {
