...
<html lang="en">
  <head>
  	<title>Kerry's K9's - Modify the discount of <?php echo $product; ?></title>
    <meta charset="utf-8">
...
<body>
    ...
    <h2 class="mb-42">Modify the discount of <?php echo $product; ?></h2>
    <div><?php echo $error_message; ?></div>
    <form action='php/modify-discount.php' method='post' id='discount'>
