...
if($countreview != 0){
    ...
    if ($updatereview){
        ...
        echo "<div class='alert alert-danger alert-dismissable fade show' role='alert'><strong>An error occured.</strong> The review was not denied. <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
