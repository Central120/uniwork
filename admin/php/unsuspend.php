...
if($countuser != 0){
    ...
    if ($updateuser){
        ...
        echo "<div class='alert alert-danger alert-dismissable fade show' role='alert'><strong>An error occured.</strong> The user is still suspended. <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
