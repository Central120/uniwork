...
<html lang="en">
  <head>
  	<title>Kerry's K9's - Remove a discount</title>
    <meta charset="utf-8">
...
<body>
    <?php include "inc/header.php"; ?>
        ...
        <center>
    <h2 class="mb-42">Remove a discount</h2>
        ...
        <div class='modal-dialog' role='document'>
          <div class='modal-content' style='width:150%;left:-10%;'>
            <div class='modal-header'>
              <h5 class='modal-title'>Are you sure you would like to delete $product's discount?</h5>
           ...
           echo "
            <form action='php/delete-discount.php' method='post' role='form'>
